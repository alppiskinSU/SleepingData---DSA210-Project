...
# 6. Scatter: SleepHours vs StudyHours
...
# 7. Scatter: SleepQuality vs StudyQuality
plt.figure(figsize=(8,6))
...
# 8. Box Plot: SleepQuality (int) vs StudyHours
plt.figure(figsize=(8,6))
...
# 10. Time Series WITH GAPS
#    Use the raw data (without fill) so missing days remain NaN and break the line.
...
# —————————————————————————————
# 11. Correlation & Hypothesis Test (on filled data)
...
# 12. Regression Analysis: SleepHours -> StudyHours (on filled data)
